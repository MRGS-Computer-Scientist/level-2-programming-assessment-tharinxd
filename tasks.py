...
class TasksFrame(tk.Frame):
    ...
    def add_task(self):
        ...
        self.subject_entry = ttk.Entry(self.add_task_window)
        self.subject_entry.pack(pady=5)

        task_label = ttk.Label(self.add_task_window, text="Task:")
        task_label.pack(pady=5)

        self.task_entry = ttk.Entry(self.add_task_window)
        ...
        self.time_entry = AutocompleteCombobox(self.add_task_window, completevalues=[f"{h:02d}:{m:02d}" for h in range(24) for m in range(0, 60, 5)])
    ...
    def submit_new_task(self):
        ...
        add_task(subject, task, due_date, time)
        self.update_tasks_table()
